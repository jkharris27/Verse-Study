...
for(const el of document.querySelectorAll('div'))if(el.textContent?.includes('V4.6')&&el.children.length===0)el.textContent=el.textContent.replace('V4.6','V4.8');
...
const saved=$('savedPickerSection');if(saved)saved.style.display='none';
